...
const CardBrand = ({ product }: Props) => {
    return (
        <div className="flex items-center gap-5 p-2 w-[400px] h-[240px] dark:bg-primary-500 bg-white  hover:scale-95 hover:shadow-lg hover:shadow-slate-400 dark:shadow-indigo-500 transition-all">
