            ...
            <div className={`flex w-[95%] h-[80vh] rounded-xl overflow-hidden ${styles.container} ${containerClass}`} id="container">
                {!login && <div className={`flex flex-col gap-4 p-4 w-4/6 h-full bg-white absolute transition-all duration-700 ease-in-out ${styles.signUpContainer}`}>
                    ...
                    <form className={`${stylesCenter} gap-4 py-6`} onSubmit={formikR.handleSubmit}>
                        ...
                        <button className="bg-sky-900 py-4 px-10 rounded-3xl border hover:scale-125 transition-transform text-white">Sign Up</button>
                ...
                {login && <div className={`flex flex-col gap-4 p-4 w-4/6 h-full bg-white absolute transition-all duration-700 ease-in-out ${styles.signInContainer}`}>
                    ...
                    <form className={`${stylesCenter} gap-4 py-6`} onSubmit={formikL.handleSubmit}>
                        ...
                        <div className="flex justify-center w-full ">
                            ...
                            <div className="relative w-3/4 md:w-2/4">
                                <input className={`${formikL.touched.password && formikL.errors.password ? 'border-2 border-red-400 placeholder:text-red-400' : ''} bg-gray-400/30 w-full  focus:outline-none text-gray-800 p-4 rounded-r-sm`} placeholder={formikL.touched.password && formikL.errors.password ? formikL.errors.password : 'Password'}
                                    type={`${show ? 'text' : 'password'}`}
                        ...
                        <button className="bg-sky-900 py-4 px-10 rounded-3xl border hover:scale-125 transition-transform text-white">Sign In</button>
