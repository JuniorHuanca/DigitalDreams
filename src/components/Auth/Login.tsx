...
const Login = ({
  ...
  return (
    <div className={`${stylesCenter} min-h-[100vh] min-w-screen`}>
      <div
        className={`flex w-[95%] h-[80vh] rounded-xl overflow-hidden ${styles.container} ${containerClass}`}
        id="container"
      >
        {!login && (
          <div
            className={`flex flex-col gap-4 p-4 w-4/6 h-full bg-white absolute transition-all duration-700 ease-in-out ${styles.signUpContainer}`}
          >
            ...
            <form
              className={`${stylesCenter} gap-4 py-6`}
              onSubmit={formikR.handleSubmit}
            >
              <h2 className="font-bold text-2xl md:text-3xl text-sky-900">
                Sign up to DigitalDreams
              </h2>
              <ProvidersLogin />
              ...
              <div className="flex justify-center w-full ">
                ...
                >
                  <HiUser
                    size={28}
                    className={`${
                      !formikR.errors.username && formikR.values.username
                        ? "fill-[#6366f1]"
                        : "fill-gray-800/30"
                    }`}
                  />
              ...
              <div className="flex justify-center w-full ">
                ...
                >
                  <HiAtSymbol
                    size={28}
                    className={`${
                      !formikR.errors.email && formikR.values.email
                        ? "fill-[#6366f1]"
                        : "fill-gray-800/30"
                    }`}
                  />
              ...
              <div className="flex justify-center w-full ">
                ...
                >
                  <HiFingerPrint
                    size={28}
                    className={`${
                      !formikR.errors.password && formikR.values.password
                        ? "fill-[#6366f1]"
                        : "fill-gray-800/30"
                    }`}
                  />
                  ...
                  <input
                    className={`${
                      formikR.touched.password && formikR.errors.password
                        ? "border-2 border-red-400 placeholder:text-red-400"
                        : ""
                    } bg-gray-400/30 w-full  focus:outline-none text-gray-800 p-4 rounded-r-sm`}
                    placeholder={
                      formikR.touched.password && formikR.errors.password
              ...
              <button className="bg-sky-900 py-4 px-10 rounded-3xl border hover:scale-125 transition-transform text-white">
                Sign Up
              </button>
            </form>
          </div>
        ...
        {login && (
          <div
            className={`flex flex-col gap-4 p-4 w-4/6 h-full bg-white absolute transition-all duration-700 ease-in-out ${styles.signInContainer}`}
          >
            <div className="flex w-full h-[12%] items-center">
              <div className="w-12 h-12">
                <Image src={Logo} alt="Logo" className="rounded-full p-2" />
            ...
            >
              ...
              <div className="flex justify-center w-full ">
                <span
                  className={`${
                    formikL.touched.emailorusername &&
                    formikL.errors.emailorusername
                      ? "bg-red-400"
                      : "bg-gray-400/30"
                  } selection:icon flex items-center p-2 rounded-l-sm`}
                >
                  <HiAtSymbol
                    ...
                    className={`${
                      !formikL.errors.emailorusername &&
                      formikL.values.emailorusername
                        ? "fill-[#6366f1]"
                        : "fill-gray-800/30"
                    }`}
                  />
              ...
              <div className="flex justify-center w-full ">
                ...
                >
                  <HiFingerPrint
                    size={28}
                    className={`${
                      !formikL.errors.password && formikL.values.password
                        ? "fill-[#6366f1]"
                        : "fill-gray-800/30"
                    }`}
                  />
        ...
        <div
          className={`w-2/6 h-full left-[66.666667%] ${styles.overlayContainer}`}
        >
          <div className={`${styles.overlay}`}>
            <div
              className={`${styles.overlayPanel} ${styles.overlayLeft} gap-4`}
            >
              ...
              <button
                className="py-4 px-7 md:px-10 rounded-3xl border border-white hover:scale-125 transition-transform"
                id="signIn"
            ...
            <div
              className={`${styles.overlayPanel} ${styles.overlayRight} gap-4`}
            >
