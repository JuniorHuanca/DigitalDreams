      ...
      <div className="relative flex flex-col gap-4 bg-white w-full xs:w-[80%] min-h-[80%] p-4 rounded-xl">
        ...
        <div className="flex justify-evenly">
          <button
            className={`${
              signInForm
                ? "border-b-2 border-sky-900 text-black"
                : "text-slate-500"
        ...
        {signInForm && login && (
          ...
          >
              ...
              <input
                className={`${
                  ...
                  formikL.errors.emailorusername
                    ...
                    : ""
                } bg-gray-400/30 w-3/4  focus:outline-none text-gray-800 p-4 rounded-r-sm`}
                placeholder={
                  formikL.touched.emailorusername &&
                  formikL.errors.emailorusername
                    ? formikL.errors.emailorusername
            ...
            <button
              className="bg-sky-900 py-4 px-10 rounded-3xl border hover:scale-125 transition-transform text-white"
              type="submit"
            >
              Sign In
            </button>
