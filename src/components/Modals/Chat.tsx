...
const Chat = () => {
  ...
  return (
    <div className="nav-item absolute right-5 md:right-32 top-16 transition-all duration-1000 ease-in-out bg-slate-100 dark:bg-primary-500 p-8 rounded-lg w-96 z-10">
