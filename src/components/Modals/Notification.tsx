  ...
  return (
    <div className="nav-item absolute right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      ...
      <div className="mt-5 ">
        ...
        <div className="mt-5">
          <Button color="white" bgColor={theme.palette.primary[300]} text="See all notifications" borderRadius="10px" width="full" icon={undefined} bgHoverColor={undefined} size={undefined} title={undefined} />
        </div>
      </div>
    </div>
  );
