...
const Cart = () => {
  ...
  return (
    <div className="bg-black/60 w-full fixed nav-item top-0 right-0 z-30">
      <div className="float-right grid grid-rows-[5%_75%_minmax(min-content,_max-content)] h-screen max-h-screen transition-all duration-1000 ease-in-out dark:text-gray-200 bg-slate-100 dark:bg-primary-500 md:w-[420px] p-8">
        {cart.length ? (
          <>
